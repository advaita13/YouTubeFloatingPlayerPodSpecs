...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A draggable floating YouTube player, similar to the YouTube App'
...
#                        DESC
  ...
  s.author           = { 'advaita13' => 'adipandya@gmail.com' }
  ...
  # s.resource = 'YouTubeFloatingPlayer/Assets.bundle'
  s.resource_bundles = {
    'YouTubeFloatingPlayer' => [
      'YouTubeFloatingPlayer/**/*.png', 'YouTubeFloatingPlayer/**/*.xib']
  }
